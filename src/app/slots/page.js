  ...
  return (
    <div className="bg-black min-h-screen text-white flex flex-col justify-between">
      ...
      <main className="px-8 py-12 text-center">
        <h2 className="text-4xl font-bold mb-8">Machines à sous</h2>
        <p className="text-gray-400 text-lg">Cette section est en cours de développement. Revenez bientôt pour découvrir toutes nos offres de machines à sous !</p>
      </main>
